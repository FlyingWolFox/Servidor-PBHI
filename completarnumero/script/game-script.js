...
function game() {
	...
	var numerosDistintos = 0; //quantidade de números distintos possiveis nas opcoes
	...
	for (i = 0; i < tamNucleo; i++) {
		arrayNucleo[i] = novaImgBlocoLogicoComRestricoes(arrayNucleo, numerosDistintos, cor);
